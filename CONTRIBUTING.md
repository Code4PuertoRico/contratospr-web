...
* Open an Issue at https://github.com/Code4PuertoRico/contratospr-web/issues
...
- Run in development mode using production API: `API_URL="https://api.contratospr.com/v1" npm run dev`
...
* Go to https://github.com/Code4PuertoRico/contratospr-web/pulls and open a new pull request with your changes.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/Code4PuertoRico/contratospr-web/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/Code4PuertoRico/contratospr-web/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
